  ...
  <div class="fb-home-body">
    ...
    <div class="fb-home-timeline-area">
      <div class="fb-home-timeline">
        ...
        //     echo createAlert("Author Data Not Found ?");
        //   } else {
        ...
        <div class="create-post">
          <div class="create-post-header">
            <img src="./assets/images/user.png" alt="" />
            <button data-bs-toggle="modal" data-bs-target="#create_post_modal">Whats on your mind ?</button>
          </div>
        ...
        ?>
            ...
            <div class="user-post">
              ...
              <!-- show grid photo-->
              <?php if (count($post->post_photo) > 0): ?>
                <?php if (count($post->post_photo) == 1): ?>
                  <div class="post-media photos-1">
                    <img
                      src="media/posts/<?php echo $post->post_photo[0]; ?>"
                      alt="" />
                  </div>
                <?php endif; ?>
                <?php if (count($post->post_photo) == 2): ?>
                  <div class="post-media photos-2">
                    <?php foreach ($post->post_photo as $photo2): ?>
                      <img
                        src="media/posts/<?php echo $photo2; ?>"
                        alt="" />
                    <?php endforeach; ?>
                  </div>
                <?php endif; ?>
                <?php if (count($post->post_photo) == 3): ?>
                  <div class="post-media photos-3">
                    <?php foreach ($post->post_photo as $photo3): ?>
                      <img
                        src="media/posts/<?php echo $photo3; ?>"
                        alt="" />
                    <?php endforeach; ?>
                  </div>
                <?php endif; ?>
                <?php if (count($post->post_photo) == 4): ?>
                  <div class="post-media photos-4">
                    <?php foreach ($post->post_photo as $photo4): ?>
                      <img
                        src="media/posts/<?php echo $photo4; ?>"
                        alt="" />
                    <?php endforeach; ?>
                  </div>
                <?php endif; ?>
        ...
        <div class="modal-body">
          ...
          <form id="post_create" method="POST" enctype="multipart/form-data">
            ...
            <div class="my-2">
              ...
              <textarea name="post_content" id="" class="form-control"></textarea>
            </div>
