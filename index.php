    ...
    <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content">
        <div class="modal-body">
          <h2>Create Post</h2>
          <button class="btn-close btns " data-bs-dismiss="modal"></button>
          <hr>
          <form id="create_post" method="POST" enctype="multipart/form-data">
            <div class="my-2">
            ...
            <div class="my-2">
              ...
              <input type="file" class="form-control" multiple name="post_photo[]">
            </div>
            ...
            <div class="my-2">
              ...
              <div class="my-2">
            <input type="submit" class="btn btn-primary d-block w-100" name="post_submit" value="Post">
        </div>
        </form>
      </div>
    </div>
